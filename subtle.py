#for some normal system functions
import sys
#for the functions of getting file name and paths and extensions
import os
#All for getting our gui ready
...
class Themes(QMainWindow):
    ...
    #for writing the selected theme number in a file so we can retrive it and apply for later
...
class CustomThemes(QMainWindow):
    ...
    def initCustomThemeUI(self):
        try:
            ...
            # so if the user dont want the new then he/she can reset the theme to
            # the previous theme which is now current
            ...
            print('in init custom theme :',str(sys.exc_info()))
...
#for selecting a theme from custom created themes
...
class UploadWindow(QMainWindow):
    ...
    def OpenFileToUpload(self):
        ...
        #filepath1 = os.path.basename(filename[0])
        filepath = filename[0]
...
# mayuresh suggestions for spotlight search
    def suggest(self):
        try:
            print('suggestion?')
